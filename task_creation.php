...
if ($task_list === NULL) {
    $task_list = array();
    $task_list[] = 'Adult literacy program volunteer';
    $task_list[] = 'Beach cleanup volunteer';
    $task_list[] = 'Food donation sorter/pantry volunteer';
	$task_list[] = 'Meal delivery to home-bound individuals volunteer';
	$task_list[] = 'Volunteer caseworker';
}
